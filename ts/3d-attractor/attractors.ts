...
export class Lorenz implements IAttractor {
  a = 10.0;
  b = 8.0 / 3;
  r = 28.0;
...
export class Aizawa implements IAttractor {
  a = 0.95;
  b = 0.7;
  c = 0.6;
  d = 3.5;
...
export class Bouali2 implements IAttractor {
  a = 1.0;
...
export class Dequan implements IAttractor {
  a = 40.0;
  b = 1.833;
  c = 0.16;
  d = 0.65;
...
export class Halvorsen implements IAttractor {
  a = 1.4;
...
export class Ikeda implements IAttractor {
  a = 1.0;
  b = 0.9;
  c = 0.4;
  d = 6.0;
...
// export class LiuChen implements IAttractor {
//   a = 2.4;
//   b = -3.78;
//   c = 14.0;
//   d = -11.0;
...
export class QiChen implements IAttractor {
  a = 38.0;
...
// export class Rayleigh implements IAttractor {
//   a = 9.0;
//   b = 5.0;
//   c = 12.0;
...
export class Rossler implements IAttractor {
  initXYZ = [-4.0, 0.0, 0.0] as XYZ;
  fov = 5;
  cameraPos = 300;
  dt = 0.005;
...
// export class Thomas implements IAttractor {
//   a = 0.19;
//   initXYZ = [4.0, 0.0, 0.0] as XYZ;
//   fov = 5;
//   cameraPos = 1000;
...
// Template
/*
export class  implements IAttractor {
  initXYZ = [] as XYZ;
  fov = 5;
  cameraPos = 1000;
  dt = 0.005;
